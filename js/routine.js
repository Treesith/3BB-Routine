...
period[1][4] = new period_class("NM Lab/Microprocessor Lab", 12,15,2,45);
period[1][5] = new period_class("Microprocessor(BRK)", 2,45,4,25);
...
period[2][4] = new period_class("DSA Lab", 12,15,2,45);
period[2][5] = new period_class("Microprocessor(BRK)", 2,45,4,25);
...
period[3][4] = new period_class("Discrete Structure(AS)", 12,15,1,55);
period[3][5] = new period_class("Machine(DS)", 1,55,3,35);
...
period[4][3] = new period_class("Discrete Structure",12,15,1,55);
period[4][4] = new period_class("Instrumentation(BRR)", 1,55,3,35);
